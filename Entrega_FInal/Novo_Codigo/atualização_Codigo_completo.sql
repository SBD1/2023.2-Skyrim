...
BEGIN
    IF NEW.xp < 0 OR NEW.mana_max < 0 OR NEW.stamina_max < 0 THEN
...
DECLARE
	...
	v_id_item CHAR(7);
BEGIN
    -- Verifica se a instância do item é um consumível
    SELECT c.tipo_consumivel, c.aumento, C.id_consumivel
    INTO v_tipo_consumivel, v_aumento, v_id_item 
    FROM INSTANCIA_ITEM ci
    JOIN CONSUMIVEL c ON ci.id_item = c.id_consumivel
    WHERE ci.id_instancia_item = p_id_instancia_item;

    -- Se a instância do item é um consumível, então faz o update
    IF FOUND THEN
        -- Verifica se já existe uma tupla na tabela consome
        UPDATE CONSOME
        SET quantidade = quantidade + 1
        WHERE id_consumivel = v_id_item
        ...
        SET vida_atual = LEAST(vida_maxima, vida_atual + CASE WHEN v_tipo_consumivel = 'Heal' THEN v_aumento ELSE 0 END),
            mana_atual = LEAST(mana_max, GREATEST(0, mana_atual + CASE WHEN v_tipo_consumivel = 'Energy' THEN v_aumento ELSE 0 END)),
            stamina_atual = LEAST(stamina_max, GREATEST(0, stamina_atual + CASE WHEN v_tipo_consumivel = 'Force' THEN v_aumento ELSE 0 END))
        WHERE id_play_character = p_id_play_character;
    ELSE
        -- Caso não seja um consumível, retorna uma mensagem de erro
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'Esta habilidade não pertence à espécie do personagem citado';
    END IF;

    -- Obter custo_stamina e dano_habilidade da tabela HABILIDADE_ESPECIE
    SELECT h.mod_mana, h.mod_vida
    INTO v_custo_stamina, v_dano_habilidade
    FROM HABILIDADE_ESPECIE h
...
-- Mostar como o banco funciona:

INSERT INTO REGIAO (id_regiao, nome)
VALUES ('REG0001', 'Vale dos cristais');

-- Inserção de Local
INSERT INTO LOCAL (id_local, nome_local, id_regiao)
VALUES ('LOC0001', 'Bosque das fadas', 'REG0001');

-- Inserção de Sala
INSERT INTO SALA (id_sala, nome_sala, id_local)
VALUES ('ROOM001', 'Jardim', 'LOC0001');

INSERT INTO SALA (id_sala, nome_sala, id_local)
VALUES ('ROOM002', 'Floresta', 'LOC0001');
...
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0003', 50.0, 100, FALSE);

INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0004', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0005', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0006', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0008', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0009', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0010', 50.0, 100, FALSE);
INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja)
VALUES ('INV0011', 50.0, 100, FALSE);

INSERT INTO INVENTARIO (id_inventario, peso_maximo, carteira, eh_loja) -- Inventario de loja
VALUES ('INV0007', 100.0, 100, TRUE);
...
INSERT INTO NOT_PLAY_CHARACTER (id_npc, nome, nivel, xp, vida_maxima, mana_max, stamina_max)
VALUES ('CHAR0002', 'Inimigo 1', 1, 50, 10, 99, 99);

INSERT INTO NOT_PLAY_CHARACTER (id_npc, nome, nivel, xp, vida_maxima, mana_max, stamina_max)
VALUES ('CHAR0003', 'Lobo', 1, 50, 10, 99, 99);

INSERT INTO NOT_PLAY_CHARACTER (id_npc, nome, nivel, xp, vida_maxima, mana_max, stamina_max)
VALUES ('CHAR0004', 'Inimigo 2', 1, 50, 10, 99, 99);

-- Instância para 'CHAR0002'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0001', 'CHAR0002', 1, 50, 100, 60, 'ROOM002', 'INV0004');

-- Instância para 'CHAR0002'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0002', 'CHAR0002', 6, 50, 100, 60, 'ROOM002', 'INV0005');

-- Instância para 'CHAR0003'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0003', 'CHAR0003', 1, 50, 100, 60, 'ROOM002', 'INV0006');

-- Instância para 'CHAR0003'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0004', 'CHAR0003', 1, 50, 100, 60, 'ROOM002', 'INV0008');

-- Instância para 'CHAR0004'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0005', 'CHAR0004', 1, 50, 100, 60, 'ROOM002', 'INV0009');

-- Instância para 'CHAR0004'
INSERT INTO INSTANCIA_NPC (id_instancia_npc, id_npc, nivel, vida_atual, mana_atual, stamina_atual, id_sala, id_inventario)
VALUES ('INPC0006', 'CHAR0004', 1, 50, 100, 60, 'ROOM002', 'INV0010');
...
INSERT INTO ENCANTAMENTO_VESTIMENTA (id_encantamento, id_vestimenta, elemento, resistencia)
VALUES ('ENCV002', 'ITEM001', 'Gelo', 10);
...
VALUES ('CHAR0001', 'Thaliana', 'N01', 00, 20, 50, 50, 100, 100, 100, 'ROOM001', 'INV0001');
...
VALUES ('HAB0001', 'Força Poder de fogo', 5, 10, 5, 0, 15, 0),
       ('HAB0002', 'Elsa', 5, 10, 0, 20, 0, 5);
	   
INSERT INTO ESPECIE (id_especie, nome, id_habilidade)
VALUES ('ESPEC01', 'Elfo', 'HAB0002');
...
INSERT INTO ESPECIE_HUMANOIDE (id_humanoide, id_habilidade, nivel, dano)
VALUES ('CHAR0001', 'HAB0002', 1, 30);

INSERT INTO MAGIA (id_magia, nome, elemento, dano_inicial, custo_mana)
VALUES ('MAG0001', 'Bola de Fogo', 'Fogo', 60, 8),
       ('MAG0002', 'Flecha de Gelo', 'Gelo', 50, 6);
...
VALUES ('MIS0001', 60, 'Obter Armadura', NULL, 'IITEM001', 'ITEM001');
...
VALUES ('ITEM101', 'Energy Drink', 10, 0.5, 'Energy', 10);

-- Instâncias do Consumível Energy no inventário 'INV0001'
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM010', 'ITEM101', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM011', 'ITEM101', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM012', 'ITEM101', 'Inventario', 'INV0001', FALSE);

-- Consumível Heal
INSERT INTO CONSUMIVEL (id_consumivel, nome, valor, peso, tipo_consumivel, aumento)
VALUES ('ITEM102', 'Healing Potion', 15, 0.7, 'Heal', 10);

-- Instâncias do Consumível Heal no inventário 'INV0001'
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM020', 'ITEM102', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM021', 'ITEM102', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM023', 'ITEM102', 'Inventario', 'INV0001', FALSE);

-- Consumível Force
INSERT INTO CONSUMIVEL (id_consumivel, nome, valor, peso, tipo_consumivel, aumento)
VALUES ('ITEM103', 'Force Elixir', 25, 1.0, 'Force', 10);

-- Instâncias do Consumível Force no inventário 'INV0001'
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM007', 'ITEM103', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM008', 'ITEM103', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM009', 'ITEM103', 'Inventario', 'INV0001', FALSE);
INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, eqp_status)
VALUES ('IITEM111', 'ITEM103', 'Inventario', 'INV0001', FALSE);

-- Associação do Consumível Energy ao personagem CHAR0001
INSERT INTO CONSOME (id_consumivel, id_play_character, Quantidade)
VALUES ('ITEM101', 'CHAR0001', 0);

-- Associação do Consumível Heal ao personagem CHAR0001
INSERT INTO CONSOME (id_consumivel, id_play_character, Quantidade)
VALUES ('ITEM102', 'CHAR0001', 0);

-- Associação do Consumível Force ao personagem CHAR0001
INSERT INTO CONSOME (id_consumivel, id_play_character, Quantidade)
VALUES ('ITEM103', 'CHAR0001', 0);
...
-- Uso da habilidade para uma habilidade que não possui:

--CALL USO_HABILIDADE('CHAR0001','HAB0001', 'INPC0001');

-- Usa da habilidade com um inimigo do mesmo nível:

 --SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0001';

 --CALL USO_HABILIDADE('CHAR0001','HAB0002', 'INPC0001');
 
 --SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0001';

-- Usa a habilidade com um inimigo de um nível maior

--SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0002';
 
 --CALL USO_HABILIDADE('CHAR0001','HAB0002', 'INPC0002');
...
-- Uso de magia que não possui:

--CALL uso_magia('CHAR0001','MAG0002', 'INPC0001');


-- Uso de magia que  possui com NPC no mesmo nível

--SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0001';

--CALL uso_magia('CHAR0001','MAG0001', 'INPC0001');

--SELECT id_instancia_npc, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0001';

-- Uso de magia que não possui com NPC em um nível superior

--SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0002';

--CALL uso_magia('CHAR0001','MAG0001', 'INPC0002');

--SELECT id_instancia_npc, nivel, vida_atual FROM INSTANCIA_NPC WHERE id_instancia_npc = 'INPC0002';

-- Aprender magia:
--INSERT INTO MAGIA_HUMANOIDE (id_humanoide, id_magia, nivel, dano)
--VALUES ('CHAR0001', 'MAG0002', 1, 60);

--INSERT INTO MAGIA_HUMANOIDE (id_humanoide, id_magia, nivel, dano)
--VALUES ('CHAR0001', 'MAG0002', 1, 50);
...
-- Vamos matar uma instancia:

--SELECT * FROM ESTA_MORTO;
...
-- Aprender um encantamento

--CALL realizar_encantamento('CHAR0001', 'ENCV002');

--INSERT INTO INSTANCIA_ITEM (id_instancia_item, id_item, tipo_local, local_inventario, local_sala, eqp_status)
--VALUES ('IITEM002', 'ITEM002', 'Inventário', 'INV0001', NULL, TRUE );

--CALL realizar_encantamento('CHAR0001', 'ENCV002');

--SELECT * FROM APRENDER_ENCANTAMENTO;

--UPDATE APRENDER_ENCANTAMENTO
--SET status = TRUE
--WHERE id_play_character = 'CHAR0001';
--SELECT * FROM APRENDER_ENCANTAMENTO;
...
--SELECT pc.nome, pc.nivel, pc.xp, mh.*, eh.*
--FROM PLAY_CHARACTER pc
--JOIN MAGIA_HUMANOIDE mh ON pc.id_play_character = mh.id_humanoide
--JOIN ESPECIE_HUMANOIDE eh ON pc.id_play_character = eh.id_humanoide
--WHERE pc.id_play_character = 'CHAR0001';
...
-- Limite máximo de consumíveis:

--SELECT * FROM CONSOME JOIN PLAY_CHARACTER ON CONSOME.id_play_character = PLAY_CHARACTER.id_play_character;


--CALL consumir('IITEM009', 'CHAR0001');
CALL consumir('IITEM020', 'CHAR0001');
CALL consumir('IITEM012', 'CHAR0001');

--SELECT * FROM CONSOME JOIN PLAY_CHARACTER ON CONSOME.id_play_character = PLAY_CHARACTER.id_play_character;
--CALL consumir('IITEM007', 'CHAR0001');
CALL consumir('IITEM008', 'CHAR0001');
CALL consumir('IITEM111', 'CHAR0001');
