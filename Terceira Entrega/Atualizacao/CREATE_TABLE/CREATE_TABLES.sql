DROP TABLE APRENDER_ENCANTAMENTO CASCADE;
DROP TABLE PROPORCIONA_ENCANTAMENTO CASCADE;
DROP TABLE GEMA CASCADE;
DROP TABLE MISSAO_OBTER_ITEM CASCADE;
DROP TABLE ENCANTAMENTO_ARMA CASCADE;
DROP TABLE ARMA CASCADE;
DROP TABLE CONSOME CASCADE;
DROP TABLE CONSUMIVEL CASCADE;
DROP TABLE ENCANTAMENTO_VESTIMENTA CASCADE;
DROP TABLE VESTIMENTA CASCADE;
DROP TABLE TIPO_ENCANTAMENTO CASCADE;
DROP TABLE INSTANCIA_ITEM CASCADE;
DROP TABLE TIPO_ITEM CASCADE;
DROP TABLE  MISSAO_MATAR_NPC CASCADE;
DROP TABLE DIALOGOS CASCADE;
DROP TABLE CUMPRE_MISSAO CASCADE;
DROP TABLE MISSAO_NIVEL CASCADE;
DROP TABLE TIPO_MISSAO CASCADE;
DROP TABLE ESTA_MORTO CASCADE;
DROP TABLE INSTANCIA_NPC CASCADE;
DROP TABLE NOT_PLAY_CHARACTER CASCADE;
DROP TABLE PLAY_CHARACTER CASCADE;
DROP TABLE HOSTILIDADE CASCADE;
DROP TABLE GOLPES_BESTA CASCADE;
DROP TABLE GOLPES CASCADE;
DROP TABLE BESTA CASCADE;
DROP TABLE MAGIA_HUMANOIDE CASCADE;
DROP TABLE MAGIA CASCADE;
DROP TABLE HUMANOIDE CASCADE;
DROP TABLE ESPECIE CASCADE;
DROP TABLE HABILIDADE_ESPECIE CASCADE;
DROP TABLE FORMA CASCADE;
DROP TABLE NIVEL CASCADE;
DROP TABLE TIPO_PERSONAGEM_HISTORIA CASCADE;
DROP TABLE INVENTARIO CASCADE;
DROP TABLE VIAGEM_SALAS CASCADE;
